...
BEGIN
  ...
  VALUES (gen_random_uuid(), v_id, left(v_name, 100), left(v_grade, 50), left(v_section, 50));
...
BEGIN
  ...
  ELSE
    INSERT INTO profiles (id, user_id, full_name, grade_level, section)
    VALUES (gen_random_uuid(), v_vid, left(v_name, 100), left(v_grade, 50), left(v_section, 50));
  END IF;
